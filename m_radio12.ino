...
static void keyb(void* pdata)
{
  ...
  while (1)
  {
    if ((gpio_get_level(VP) == 1) && (ec0 == 1)) {
      b0 = v0;
      ec0 = 0;
    }
    if ((gpio_get_level(VP) == 1) && (b0 == -1)) {
      v0 = 0;
      ec0 = 0;
    }
    ...
    if ((gpio_get_level(VM) == 1) && (ec1 == 1)) {
      b1 = v1;
      ec1 = 0;
    }
    if ((gpio_get_level(VM) == 1) && (b1 == -1)) {
      v1 = 0;
      ec1 = 0;
    }
    ...
    if ((gpio_get_level(MU) == 1) && (ec2 == 1)) {
      b2 = v2;
      ec2 = 0;
    }
    if ((gpio_get_level(MU) == 1) && (b2 == -1)) {
      v2 = 0;
      ec2 = 0;
    }
...
void setup()
{
  ...
  */
  ...
  if ((gpio_get_level(VP) == 0) && (gpio_get_level(VM) == 0) && (gpio_get_level(MU) == 0)) {
    factory_test();
  }
  else {
